    ...
    <section id="meet-agent" className="section-padding bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto container-padding relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative animate-fade-in-up flex flex-col items-center lg:items-start">
            {/* Photo Container */}
            <div className="relative w-full max-w-[280px] lg:max-w-[320px] aspect-[3/4] rounded-2xl overflow-hidden shadow-2xl hover:shadow-glow-lg transition-all duration-300 hover:scale-[1.02] mb-4">
            ...
            {/* Credential Badge - Positioned below photo */}
            <div className="w-full max-w-[280px] lg:max-w-[320px] glass rounded-xl p-4 backdrop-blur-md border border-white/30 shadow-xl">
