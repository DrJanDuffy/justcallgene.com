...
export const metadata: Metadata = {
  ...
  description: 'Probate Real Estate Specialist (CPRES) and Probate Expert (CPE) serving Orange County. Expert guidance for probate property sales in Newport Beach, Irvine, and Corona Del Mar. Compassionate probate real estate services.',
  keywords: [
    'probate real estate',
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-neutral-700 leading-relaxed mb-6">
                Selling a probate property is one of the most challenging real estate transactions you may face. It combines the emotional difficulty of dealing with a loved one's estate with the complexity of legal requirements, court procedures, and real estate processes. As certified Probate Real Estate Specialists (CPRES) and Probate Experts (CPE), we understand these challenges and provide the expertise, compassion, and guidance needed to navigate probate real estate successfully.
              </p>
