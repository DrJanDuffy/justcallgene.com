        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-lg shadow-md p-8">
            ...
            <p className="text-base text-neutral-700 mb-8">
              As certified Probate Real Estate Specialists (Probate Real Estate Specialists), we provide professional property valuations that meet court requirements for probate proceedings. Our valuations help determine fair market value for estate tax purposes, distribution to heirs, and establishing listing prices.
            </p>
